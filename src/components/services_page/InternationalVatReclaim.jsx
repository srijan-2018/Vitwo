        ...
        <div className="container service">
            <div className="row">
              ...
              <div className='col-lg-12'>
                <h5>OUR PROCESS</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, ratione itaque? Nemo dicta minima dolore! Placeat, reprehenderit
                  assumenda! Similique assumenda voluptates architecto laboriosam quia.</p>
              </div>
              ...
              <div className='col-lg-12 mt-4 display_res'>
                <main className="main">
                          ...
                          <div className="flip-card__container">
                            <div className="card-front">
                              <div className="card-front__tp card-front__tp--city">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 60" style={{ enableBackground: 'new 0 0 60 60' }} xmlSpace="preserve" className="card-front__icon">
                                  <g>
              ...
              <div className='col-lg-12 mb-5 display_res'>
                <main className="main">
                  <section className="card-area">
                    {/* Card: Beach */}
                    <section className="card-section">
              ...
              <div className='col-lg-12 mb-5'>
                <h2 className='mb-3'>ANALYSIS CHARTS</h2>
                ...
                <div className='row'>
                  ...
                  <h4 className='progressbar-text'>RETURNING CUSTOMERS</h4>
                  </div>
                  <div className='col-lg-4'>
                    <div role="progressbar" aria-valuenow="47" aria-valuemin="0" aria-valuemax="100" style={{ "--value": "47" }}></div>
                    <h4 className='progressbar-text'>SUCCESS RATE</h4>
                  </div>
                  <div className='col-lg-4'>
                    <div role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style={{ "--value": "50" }}></div>
                    <h4 className='progressbar-text'>COMPLETED PROJECTS</h4>
                  </div>
                </div>
              </div>
...
export default InternationalVatReclaim